...
//#define USE_LE01MR                               // Add support for F&F LE-01MR Modbus energy monitor (+1k code)
  ...
  #define USE_RESISTIVE_LOAD                     // Resistive constant power measurement
...
#define USE_TIMEPROP    //  include the timeprop feature (+1.2k)
 ...
 #define USE_PID         // include the pid feature (+4.3k)
   ...
   #define PID_PROPBAND                 4 //5        // Proportional band in process units (eg degrees). This controls
   ...
   #define PID_INTEGRAL_TIME             (15*60)//1800    // Integral time seconds. This is a setting for the integral time,
   ...
   #define PID_MAX_INTERVAL              500     // This is the maximum time in seconds that is expected between samples.
   ...
   #define PID_UPDATE_SECS               15//0       // How often to run the pid algorithm (integer secs) or 0 to run the algorithm
